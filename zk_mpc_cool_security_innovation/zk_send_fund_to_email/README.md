...
|--------------------------------------------------------------|----------------|------------------|-------------------|--------------------------------------------------------|-------------|
| Learn DKIM parsing and how to extract public keys from DNS   | 🟢 Easy        | 1–2 days         | Non-ZK            | Many Rust crates exist                                 |             |
| Write Rust code to verify DKIM signature                     | 🟡 Medium      | 3–5 days         | Non-ZK            | Can base on open-source DKIM libraries                 | in-progress |
